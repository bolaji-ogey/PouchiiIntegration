 ...
 */
public class LoanApplicationNotificationReq extends  RequestBase {
    ...
    public  final  String  convertToJSONString(){
     ...
     public   final  LoanApplicationNotificationReq  readFromJSONAndLog(Connection con, final String  inObjectJSON){ 
        LoanApplicationNotificationReq   loanApplicationNotificationReq  =  null;
        ObjectMapper objectMapper = new ObjectMapper();
        try{
              objectMapper.setVisibility(PropertyAccessor.FIELD, JsonAutoDetect.Visibility.ANY);
              loanApplicationNotificationReq = objectMapper.readValue(inObjectJSON, LoanApplicationNotificationReq.class);
        ...
        return  loanApplicationNotificationReq;
    }
     
     
     
    public  static  LoanApplicationNotificationReq  readFromJSON(String  inObjectJSON){ 
         LoanApplicationNotificationReq  loanApplicationNotificationReq  =  null;
        ObjectMapper objectMapper = new ObjectMapper();
        try{
              objectMapper.setVisibility(PropertyAccessor.FIELD, JsonAutoDetect.Visibility.ANY);
