 ...
 */
package i.ogeyingbo.single.node.wallet.integration.newpartner.setup.responses;
...
import i.ogeyingbo.single.node.wallet.integration.newpartner.setup.requests.AdminRequestBase;

/**
 *
 * @author BOLAJI-OGEYINGBO
 */
public class AdminResponseBase   extends   AdminRequestBase {
