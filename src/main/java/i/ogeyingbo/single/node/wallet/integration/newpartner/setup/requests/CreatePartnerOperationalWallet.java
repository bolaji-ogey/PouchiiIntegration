 ...
 */
public class CreatePartnerOperationalWallet  extends   AdminRequestBase {
    ...
    private     String  walletName =  "HACK-5 Operational Wallet";
    private  final  boolean  status =  true;
    private  final  String  walletOperationType =  "Any";
    private   String  bankAccountName =  "HACK-5 Operational Wallet";
   private    String  bankAccountNumber =  "1234500081";                                                                                                                                                                                      
    ...
    public String  getBankAccountNumber(){
     ...
     public void  getPartnerId(long  inPartnerId){
         partnerId = inPartnerId;
    }
    
    public void  getMerchantId(long  inMerchantId){
         merchantId = inMerchantId;
    }
    
     public void  getWalletName(String inWalletName){
        walletName = inWalletName;
    }
    
    
    public void  getBankAccountName(String  inBankAccountName){
          bankAccountName = inBankAccountName;
    }
    
    public void  getBankAccountNumber(String  inBankAccountNumber){
