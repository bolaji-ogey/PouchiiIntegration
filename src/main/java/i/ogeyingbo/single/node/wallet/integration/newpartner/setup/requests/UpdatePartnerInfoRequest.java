 ...
 */
public class UpdatePartnerInfoRequest  extends   AdminRequestBase {
    ...
    private  String  supportEmailSender = "HACK-5 Support<noreply@pouchii.net>";
    ...
    private  String  kycLevel = "Level1";
