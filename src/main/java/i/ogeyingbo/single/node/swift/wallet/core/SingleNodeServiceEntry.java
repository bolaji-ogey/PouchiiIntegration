 ...
 */
public class SingleNodeServiceEntry extends AbstractVerticle {
  ...
  public static void main(String[] args) {
      ...
      deployOptions.setInstances(5);
       ...
       vertx.deployVerticle(new SingleNodeServiceWorker());
       vertx.deployVerticle(new SingleNodeServiceEntry());
