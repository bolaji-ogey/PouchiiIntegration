...
public class WalletTestData    extends     AuthourizationInterface {
    ...
    public static  final String   SEND_MONEY_TO_WALLET       = "/transactionservice/send-money";    // POST
    ...
    public static  final String   WALLET_TRXNS_HIST            = "/transactionservice/rest/api/my/transaction/history";   // GET
