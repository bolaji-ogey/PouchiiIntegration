...
public class AuthourizationTestData     extends     AuthourizationInterface {
  ...
  public static  final String   LOGIN       = "/identityservice/rest/api/integration/authentication/credential";     // POST
  ...
  public static  final String   FORGET_PASSWORD_II  = "/changelostpassword";  // POST
   ...
   public static  final String  BANK_LIST  = "/walletservice/rest/api/wallet/bank/list"; //GET
