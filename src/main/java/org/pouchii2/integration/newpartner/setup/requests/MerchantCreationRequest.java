 ...
 */
public class MerchantCreationRequest  extends   PouchiiAdminRequestBase {
    ...
    private  String  businessDescription = "_";
    ...
    private  int[]  partnerIds = new int[1];
    private  Long[]  applicationIds = new Long[1];
   
     
    
    public   MerchantCreationRequest(){ 
        applicationIds[0] =     1L;
    }
    ...
    public  void  setPartnerIds(int   inPartnerIds){
          partnerIds[0] = inPartnerIds;
    }
