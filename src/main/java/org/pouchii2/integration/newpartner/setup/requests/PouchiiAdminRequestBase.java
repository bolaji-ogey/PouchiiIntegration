 ...
 */
public class PouchiiAdminRequestBase {
     
    private    String  requestChannelId = "00000000";
    private      String  requestChannel = "Web";
    private      String  requestChannelType = "Desktop_Browser";
