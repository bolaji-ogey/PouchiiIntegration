 ...
 */
public class DataSubscriptionRequest    extends  PouchiiRequestBase   {
    ...
    public  final  String  convertToJSONString(){
     ...
     public   final  DataSubscriptionRequest  readFromJSONAndLog(Connection con, final String  inObjectJSON){ 
        DataSubscriptionRequest   dataSubscriptionRequest  =  null;
        ObjectMapper objectMapper = new ObjectMapper();
        try{
              objectMapper.setVisibility(PropertyAccessor.FIELD, JsonAutoDetect.Visibility.ANY);
              dataSubscriptionRequest = objectMapper.readValue(inObjectJSON, DataSubscriptionRequest.class);
    ...
    public  static  DataSubscriptionRequest  readFromJSON(String  inObjectJSON){ 
        DataSubscriptionRequest  dataSubscriptionRequest  =  null;
        ObjectMapper objectMapper = new ObjectMapper();
        try{
              objectMapper.setVisibility(PropertyAccessor.FIELD, JsonAutoDetect.Visibility.ANY);
